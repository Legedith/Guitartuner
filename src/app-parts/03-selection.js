function resetPitchTracking() { pitchHistory = []; lastPitchAt = 0; stableTargetIndex = null; stableSince = 0; pendingAutoTarget = null; pendingAutoFrames = 0; quietSignalSince = 0; unclearSignalSince = 0; }
